...
# Configure Antigravity HUD

**FIRST**: Use the Read tool to load `~/.gemini/antigravity-cli/plugins/agy-hud/config.json` if it exists.
...
Write to `~/.gemini/antigravity-cli/plugins/agy-hud/config.json`.
